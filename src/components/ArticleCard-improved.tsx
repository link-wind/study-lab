...
export default function ArticleCard({ title, description, date, slug, tags = [], image }: ArticleCardProps) {
  return (
    <article className="group relative bg-card/80 backdrop-blur-sm rounded-2xl border border-border/50 hover:border-primary/30 hover:shadow-lg transition-all duration-200 overflow-hidden">
      {/* 图片区域 */}
      {image && (
